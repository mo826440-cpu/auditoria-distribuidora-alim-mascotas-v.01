    ...
    <div className="mt-6">
        ...
        <table className="w-full text-sm">
          <thead className="bg-slate-50 border-b border-slate-200">
            <tr>
              ...
              <th className="text-left py-3 px-4 font-medium text-slate-700">Transporte</th>
              {canEdit && (
            ...
            {transportes.length === 0 ? (
              ...
              transportes.map((t) => (
                <tr key={t.id} className="border-b border-slate-100 hover:bg-slate-50">
                  <td className="py-3 px-4">{formatFecha(t.updated_at || t.created_at)}</td>
                  <td className="py-3 px-4 font-medium">{t.marca}</td>
                  {canEdit && (
      ...
      {(modal === "nuevo" || modal === "editar") && (
        <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/40 overflow-y-auto py-6 px-4">
          <div className="bg-white rounded-xl p-6 w-full max-w-md shadow-xl my-2">
      ...
      {deleteConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-xl p-6 w-full max-w-md shadow-xl">
            <h2 className="text-lg font-semibold text-slate-900">¿Eliminar transporte?</h2>
