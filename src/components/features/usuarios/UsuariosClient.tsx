            ...
            {usuarios.map((u) => (
              <tr key={u.id} className="border-b border-slate-700 hover:bg-slate-700/50">
                ...
                <td className="py-3 px-4 text-right">
                  ...
                  {u.id !== currentUserId && u.rol !== "administrador" && (
                    <button
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3 py-2 pr-11 border border-slate-600 rounded-lg bg-slate-800 text-slate-200 placeholder:text-slate-500 focus:ring-2 focus:ring-primary-500 outline-none"
                  />
                  <button
                    type="button"
